# 2020 年最新注册 Google Voice 号码，成功率极高，一定按照以下步骤严格操作
...
* 打开 [https://ipdata.co/](https://ipdata.co/)， 输入上一步查出来的代理IP地址，测试路线为 `家庭` 或 `托管`。
...
免费的步骤较繁琐一点，但不复杂。通过flyp虚拟号码可以接收google voice验证码（已验证），但是注册flyp也是需要一个美国的电话号码，这时就可以注册说道APP来获得一个专属美国电话号码<br>

* 说道APP，苹果手机需要用美区AppleID下载，没有美区ID的可自行注册一个。安卓手机在Google Play里下载安装。支持中国手机号码直接注册。[说道APP官网](https://tku.page.link/nLs3)
* 说道APP可通过250个说道币兑换一个价值4.99$的美国专属号码
